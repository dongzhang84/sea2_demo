...
**Phase 1 数据表已抽** → [`output/game_data/`](output/game_data/) 含 29 个 JSON dump（港口 stats、风/洋流网格、海怪 stats、Data1.lzw 各 part 等）。

**Phase 2 RE 进度** → [`docs/PHASE2_PROGRESS.md`](docs/PHASE2_PROGRESS.md)（找到文件 wrapper + KOUKAI2.DAT 主数据文件）。

**Phase 3 新游戏设计 spec** → [`docs/PHASE3_DESIGN_DOC.md`](docs/PHASE3_DESIGN_DOC.md)（基于 Phase 0-2 综合的新游戏 spec，含 MVP→Beta→v1 roadmap）。

**Phase 4 新游戏 MVP** → [`game/`](game) — Godot 4 项目，世界地图 + 10 港口 + 交易 + 风向 + 船导航。已用上 RE 出来的头像/道具图标/港口大图/NPC sprite。
