...
> **版本说明**：磁盘上的是**大陆汉化版**（不是日文原版）。`2.pat` 是简体中文字模（6800 字），消息文本中的双字节对通过自定义查找表索引到 2.pat。日文原版的 Shift-JIS 在这里被换成了一个未知 byte→tile mapping。
...
| `2.pat` — 简体中文字体（6800 个 16×16 字模）| ✅ | ![](output/fonts/2pat_first256.png) |
| 数据表（`.dat`）| ⬜ | — |
