...
def build_bundle() -> dict:
    ...
    events = {
        "nodes": [
            {"id": "S1_E1", "label": "被逐出家门", "line": "Snr1"},
            {"id": "S1_E2", "label": "公爵府筹资", "line": "Snr1"},
            {"id": "S1_E3", "label": "造船完成", "line": "Snr1"},
            {"id": "S1_E4", "label": "恩里克神父同行", "line": "Snr1"},
            {"id": "S1_E5", "label": "约翰传闻", "line": "Snr1"},
            {"id": "S1_E6", "label": "卡特琳娜卷入", "line": "Snr1"},
            {"id": "S2_E1", "label": "哥哥失踪", "line": "Snr2"},
            {"id": "S2_E2", "label": "调查真相", "line": "Snr2"},
            {"id": "S2_E3", "label": "军方阻止", "line": "Snr2"},
            {"id": "S2_E4", "label": "港口情报循环", "line": "Snr2"},
            {"id": "S2_E5", "label": "卡特琳娜卷入", "line": "Snr2"},
            {"id": "S2_E6", "label": "私掠 / 复仇", "line": "Snr2"},
            {"id": "S3_E1", "label": "国王召见", "line": "Snr3"},
            {"id": "S3_E2", "label": "私掠许可 / 资金", "line": "Snr3"},
            {"id": "S3_E3", "label": "组建舰队", "line": "Snr3"},
            {"id": "S3_E4", "label": "对抗西班牙", "line": "Snr3"},
            {"id": "S4_E1", "label": "梅尔卡特求助", "line": "Snr4"},
            {"id": "S4_E2", "label": "世界地图计划", "line": "Snr4"},
            {"id": "S4_E3", "label": "劳拉找家乡", "line": "Snr4"},
            {"id": "S4_E4", "label": "黄海 / 日本", "line": "Snr4"},
            {"id": "S4_E5", "label": "南美 / 黄金之国", "line": "Snr4"},
            {"id": "S5_E1", "label": "欠债 / 无资助", "line": "Snr5"},
            {"id": "S5_E2", "label": "公爵夫人资助", "line": "Snr5"},
            {"id": "S5_E3", "label": "冒险报告", "line": "Snr5"},
            {"id": "S5_E4", "label": "金质奖章", "line": "Snr5"},
            {"id": "S5_E5", "label": "黄金之国 / 圣人手杖", "line": "Snr5"},
            {"id": "S5_E6", "label": "法布利斯 / 家族线", "line": "Snr5"},
            {"id": "S6_E1", "label": "穷困 / 没船", "line": "Snr6"},
            {"id": "S6_E2", "label": "萨达姆帮忙", "line": "Snr6"},
            {"id": "S6_E3", "label": "修船 / 借债", "line": "Snr6"},
            {"id": "S6_E4", "label": "贸易 / 投资", "line": "Snr6"},
            {"id": "S6_E5", "label": "寻找薩莎", "line": "Snr6"},
            {"id": "S6_E6", "label": "奥斯曼任务 / 同盟港", "line": "Snr6"},
        ],
        "edges": [
